package net.example.ednutynex.myproject;
...
import net.example.ednutynex.myproject.controller.DetailActivity;
...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            //cardview to display developer details
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (pos != RecyclerView.NO_POSITION) {
                        ...
                        Toast.makeText(v.getContext(), "Showing " + clickedDataItem.getLogin(), Toast.LENGTH_SHORT).show();
                    }
                }
